<div>
    <form>
        <div class="col-lg-6 col-sm-12">
            ...
            <input type="hidden" name="model_type" wire:model="model_id">
            <div class="mb-3 row">
                <label for="staticEmail" class="col-sm-2 col-form-label">Имя</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name"
                           value="Игорь Гантелькин" wire:model="name">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="job_title" name="job_title"
                           value="Директор" wire:model="job_title">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" id="type" name="type" wire:model="type">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="value"  name="value" placeholder="+79047160000" wire:model="value">
                </div>
            </div>
